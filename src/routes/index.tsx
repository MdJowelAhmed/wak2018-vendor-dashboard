...
const AnalyticsPage = lazy(() => import('@/features/dashboard/pages/vendor/AnalyticsPage').then(m => ({ default: m.AnalyticsPage })));
const DashboardPage = lazy(() => import('@/features/dashboard/pages/vendor/DashboardPage').then(m => ({ default: m.DashboardPage })));
const DeliveryRequestsPage = lazy(() => import('@/features/delivery/pages/DeliveryRequestsPage').then(m => ({ default: m.DeliveryRequestsPage })));
const DriverQueuePage = lazy(() => import('@/features/delivery/pages/DriverQueuePage').then(m => ({ default: m.DriverQueuePage })));
...
const CustomerDetailsPage = lazy(() => import('@/features/customers/pages/vendor/CustomerDetailsPage').then(m => ({ default: m.CustomerDetailsPage })));
const CustomersManagementPage = lazy(() => import('@/features/customers/pages/vendor/CustomersManagementPage').then(m => ({ default: m.CustomersManagementPage })));
...
const ServiceCreatePage = lazy(() => import('@/features/services/pages/vendor/ServiceCreatePage').then(m => ({ default: m.ServiceCreatePage })));
const ServiceDetailsPage = lazy(() => import('@/features/services/pages/vendor/ServiceDetailsPage').then(m => ({ default: m.ServiceDetailsPage })));
const ServiceFormPage = lazy(() => import('@/features/services/pages/vendor/ServiceFormPage').then(m => ({ default: m.ServiceFormPage })));
const ServicesListPage = lazy(() => import('@/features/services/pages/vendor/ServicesListPage').then(m => ({ default: m.ServicesListPage })));
const SettingsPage = lazy(() => import('@/features/settings/pages/SettingsPage').then(m => ({ default: m.SettingsPage })));
const ControllerManagement = lazy(() => import('@/features/settings/pages/ControllerManagement').then(m => ({ default: m.ControllerManagement })));
const ServiceOnboardingPage = lazy(() => import('@/features/auth/pages/onboarding/service/ServiceOnboardingPage').then(m => ({ default: m.ServiceOnboardingPage })));
const VendorOnboardingPage = lazy(() => import('@/features/auth/pages/onboarding/vendor/VendorOnboardingPage').then(m => ({ default: m.VendorOnboardingPage })));
const EarningsPage = lazy(() => import('@/features/dashboard/pages/vendor/EarningsPage').then(m => ({ default: m.EarningsPage })));
const ServiceDashboardPage = lazy(() => import('@/features/dashboard/pages/service/DashboardPage').then(m => ({ default: m.DashboardPage })));
const ServiceServicesPage = lazy(() => import('@/features/services/pages/service/ServicesPage').then(m => ({ default: m.ServicesPage })));
const ServiceBookingsPage = lazy(() => import('@/features/orders/pages/BookingsPage').then(m => ({ default: m.BookingsPage })));
const ServiceEarningsPage = lazy(() => import('@/features/dashboard/pages/service/EarningsPage').then(m => ({ default: m.EarningsPage })));
const ServiceSettingsPage = lazy(() => import('@/features/settings/pages/ServiceSettingsPage').then(m => ({ default: m.SettingsPage })));
const AddServicePage = lazy(() => import('@/features/services/pages/service/AddServicePage').then(m => ({ default: m.AddServicePage })));
const ServiceDetails = lazy(() => import('@/features/services/pages/service/ServiceDetails').then(m => ({ default: m.ServiceDetails })));
const ServiceAnalyticsPage = lazy(() => import('@/features/dashboard/pages/service/AnalyticsPage').then(m => ({ default: m.AnalyticsPage })));
const ServiceCustomersManagementPage = lazy(() => import('@/features/customers/pages/service/CustomersManagementPage').then(m => ({ default: m.CustomersManagementPage })));
const ServiceCustomerDetailsPage = lazy(() => import('@/features/customers/pages/service/CustomerDetailsPage').then(m => ({ default: m.CustomerDetailsPage })));
const ServiceControllerManagementPage = lazy(() => import('@/features/settings/pages/ControllerManagementPage').then(m => ({ default: m.ControllerManagementPage })));
const ServiceMessagesPage = lazy(() => import('@/features/chat/pages/ServiceMessagesPage').then(m => ({ default: m.MessagesPage })));
